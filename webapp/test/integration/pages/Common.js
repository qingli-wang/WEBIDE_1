sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ZWQL_TEST_03/ZWQL_TEST_03/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("ZWQL_TEST_03.ZWQL_TEST_03.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ZWQL_TEST_03/ZWQL_TEST_03/localService/mockserver"], function (mockserver) {
